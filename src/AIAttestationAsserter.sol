...
contract AIAttestationAsserter {
    ...
    function assertDataFor(
        ...
        assertionId = oo.assertTruth(
            abi.encodePacked(
                "The following CID contains a statement that was actually generated by AI", // in the example data is type bytes32 so we add the hex prefix 0x.
                ...
                " is valid. Instructions at: https://github.com/jordan-public/optimistic-ai-attestation/tree/main"
            ),
            asserter,
            address(this),
